...
project = u'PET'
copyright = u'2014-%d, Jan Paral & Team' % (dt.datetime.today().year)
...
version = '%s' % (petversion.short)
# The full version, including alpha/beta/rc tags.
release = '%s' % (petversion.full)
...
#html_sidebars = {}
html_sidebars = {'**': ['localtoc.html', 'searchbox.html', 'sourcelink.html']}
...
latex_documents = [
  ('index', 'PET-manual.tex', u'PET Manual',
   u'Jan Paral & Team', 'manual'),
]
...
# man_pages = [
#     ('index', 'myproject', u'My Project', [u'Ryan Roemer'], 1)
# ]
